...
#reverse padding
def depadding(binary) :
	while (binary[len(binary) - 1] == '00000001' or binary[len(binary) - 1] == '00000000') :
...
def hex2bits(ss) :
	...
	for i in range(0, len(ss) - 1, 2) :
		binary.append(format(int(ss[i]+ss[i+1], 16), '08b'))
	return (binary)
...
# plain =  ""
# if len(sys.argv) == 1:
#     print("Aucun argument donn\xc3\xa9. Rien \xc3\xa0 hacher. Bye bye.")
# elif len(sys.argv) >= 2 :
#     plain += sys.argv[1]
